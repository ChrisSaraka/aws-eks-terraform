		...
		stage("SSH to k8s client") {
			steps {
				sshagent(['bootstrap-server']) {
    				...
    				sh "scp -o StrictHostKeyChecking=no storage.yaml ec2-user@35.179.54.243:/home/ec2-user/"
    				sh "scp -o StrictHostKeyChecking=no mongo-stack.yaml ec2-user@35.179.54.243:/home/ec2-user/"
    				sh "scp -o StrictHostKeyChecking=no workloads.yaml ec2-user@35.179.54.243:/home/ec2-user/"
